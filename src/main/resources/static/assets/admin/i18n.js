  ...
  const messages = {
    en: {
      ...
      communityPuzzles: {
        ...
        boardLabel: 'Community puzzle board',
        answerNavigation: 'Answer move navigation',
        previousAnswerMove: 'Previous answer move',
        nextAnswerMove: 'Next answer move',
      ...
      notices: {
        heading: 'Notices',
        description: 'Manage the required app versions, public announcements, and one-time personal notices.',
        systemHeading: 'System',
        systemDescription: 'Applies to every app launch as soon as it is saved.',
        androidVersion: 'Required Android Version',
        iosVersion: 'Required iOS Version',
        versionPlaceholder: 'e.g. 1.0.0',
        versionHelp: 'Clients on any other version are asked to update, per OS.',
        versionRequired: 'Enter the required version for both Android and iOS.',
        systemCheck: 'System Check Mode',
        systemCheckHelp: 'When on, every client sees the system check screen instead of the app.',
        systemCheckConfirm: 'Turn on system check mode? Every user will be blocked from the app until it is turned off.',
        systemSaved: 'System info saved.',
        systemSaveFailed: 'Failed to save system info.',
        systemLoadFailed: 'Failed to load system info.',
        announcementsHeading: 'Announcements',
        announcementsDescription: 'Public announcements shown in the app until they expire.',
        newAnnouncement: 'New Announcement',
        createHeading: 'Create Announcement',
        createDescription: 'Fill one or more language sections. Each language you fill becomes its own announcement sharing the expiration time below.',
        editHeading: 'Edit Announcement',
        body: 'Body',
        ...
        active: 'Active',
        expired: 'Expired',
        needContent: 'Enter a title and body for at least one language.',
        needTitleAndBody: 'For each language you use, enter both title and body.',
        needExpiredAt: 'Choose a valid expiration time.',
        creating: 'Creating announcement...',
        ...
        zero: '0 announcements',
        unknownCount: 'Loading...',
        personalHeading: 'Personal Notice',
        personalDescription: 'Send a one-time message to a single user. It is shown on the next app launch and then removed.',
        recipientSearch: 'Email or nickname',
        recipientSearchPlaceholder: 'Exact email or nickname',
        recipient: 'Recipient',
        noRecipient: 'No user found with that email or nickname.',
        message: 'Message',
        messagePlaceholder: 'Message shown to the user',
        needRecipient: 'Search for a recipient first.',
        needMessage: 'Enter a message.',
        send: 'Send',
        sending: 'Sending...',
        sent: 'Notice sent to {nickname}.',
        sendFailed: 'Failed to send notice.'
      },
      msg: {
    ...
    ko: {
      ...
      communityPuzzles: {
        ...
        detailHeading: '문제 정보',
        boardLabel: '커뮤니티 문제 보드',
        answerNavigation: '정답 수 이동',
        previousAnswerMove: '이전 정답 수',
        nextAnswerMove: '다음 정답 수',
        answerProgress: '{current} / {total}',
      ...
      notices: {
        heading: '공지',
        description: 'OS별 앱 필수 버전, 공개 공지사항, 1회성 개인 알림을 관리합니다.',
        systemHeading: '시스템',
        systemDescription: '저장 즉시 모든 앱 실행에 적용됩니다.',
        androidVersion: '필수 Android 버전',
        iosVersion: '필수 iOS 버전',
        versionPlaceholder: '예: 1.0.0',
        versionHelp: 'OS별로 다른 버전의 클라이언트에는 업데이트 안내가 표시됩니다.',
        versionRequired: 'Android와 iOS 필수 버전을 모두 입력하세요.',
        systemCheck: '점검 모드',
        systemCheckHelp: '켜면 모든 클라이언트에 앱 대신 점검 화면이 표시됩니다.',
        systemCheckConfirm: '점검 모드를 켤까요? 끌 때까지 모든 유저가 앱을 사용할 수 없습니다.',
        systemSaved: '시스템 정보를 저장했습니다.',
        systemSaveFailed: '시스템 정보 저장에 실패했습니다.',
        systemLoadFailed: '시스템 정보를 불러오지 못했습니다.',
        announcementsHeading: '공지사항',
        announcementsDescription: '만료 전까지 앱에 표시되는 공개 공지입니다.',
        newAnnouncement: '새 공지',
        createHeading: '공지 작성',
        createDescription: '언어 섹션을 하나 이상 채우세요. 채운 언어마다 아래 만료 시각을 공유하는 공지가 각각 생성됩니다.',
        editHeading: '공지 수정',
        body: '내용',
        ...
        active: '게시 중',
        expired: '만료',
        needContent: '언어를 하나 이상 골라 제목과 내용을 입력하세요.',
        needTitleAndBody: '사용하는 언어마다 제목과 내용을 모두 입력하세요.',
        needExpiredAt: '올바른 만료 시각을 선택하세요.',
        creating: '공지를 생성하는 중...',
        created: '공지를 생성했습니다.',
        createFailed: '공지 생성에 실패했습니다.',
        saving: '저장하는 중...',
        updated: '공지를 수정했습니다.',
        updateFailed: '공지 수정에 실패했습니다.',
        deleteConfirm: '이 공지를 삭제할까요? 되돌릴 수 없습니다.',
        deleted: '공지를 삭제했습니다.',
        ...
        zero: '공지 0건',
        unknownCount: '불러오는 중...',
        personalHeading: '개인 알림',
        personalDescription: '유저 한 명에게 1회성 메시지를 보냅니다. 다음 앱 실행 시 표시된 뒤 삭제됩니다.',
        recipientSearch: '이메일 또는 닉네임',
        recipientSearchPlaceholder: '정확한 이메일 또는 닉네임',
        recipient: '받는 사람',
        noRecipient: '해당 이메일 또는 닉네임의 유저가 없습니다.',
        message: '메시지',
        messagePlaceholder: '유저에게 표시할 메시지',
        needRecipient: '먼저 받는 사람을 검색하세요.',
        needMessage: '메시지를 입력하세요.',
        send: '보내기',
        sending: '보내는 중...',
        sent: '{nickname}님에게 알림을 보냈습니다.',
