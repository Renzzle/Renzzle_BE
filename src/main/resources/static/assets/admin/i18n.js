(function () {
  ...
  const messages = {
    en: {
      ...
      notices: {
        heading: 'Notices',
        description: 'Manage the required app version, public announcements, and one-time personal notices.',
        ...
        versionHelp: 'Clients on any other version are asked to update.',
        versionRequired: 'Enter the required app version.',
    ...
    ko: {
      ...
      notices: {
        heading: '공지',
        description: '앱 필수 버전, 공개 공지사항, 1회성 개인 알림을 관리합니다.',
        systemHeading: '시스템',
        systemDescription: '저장 즉시 모든 앱 실행에 적용됩니다.',
        version: '필수 앱 버전',
        versionPlaceholder: '예: 1.0.0',
        versionHelp: '다른 버전의 클라이언트에는 업데이트 안내가 표시됩니다.',
        versionRequired: '필수 앱 버전을 입력하세요.',
        systemCheck: '점검 모드',
