...
public interface PuzzleCacheRepository extends JpaRepository<PuzzleCache, Long> {
    ...
    void deleteAllByPuzzleTypeAndPuzzleId(PuzzleType puzzleType, Long puzzleId);

    void deleteAllByPuzzleTypeAndPuzzleIdIn(PuzzleType puzzleType, List<Long> puzzleIds);
}
