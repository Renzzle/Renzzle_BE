...
public enum ErrorCode {
    ...
    METHOD_NOT_ALLOWED(HttpStatus.METHOD_NOT_ALLOWED, "G405", "지원하지 않는 HTTP 메서드입니다."),
    UNSUPPORTED_MEDIA_TYPE(HttpStatus.UNSUPPORTED_MEDIA_TYPE, "G415", "지원하지 않는 미디어 타입입니다."),
    ...
    NO_BOARD_STATUS(HttpStatus.BAD_REQUEST, "P4005", "퍼즐 ID 또는 보드 상태가 없습니다."),
    INVALID_ANSWER_POSITION(HttpStatus.BAD_REQUEST, "P4006", "정답 수의 좌표가 올바르지 않습니다. (a~o, 1~15)"),
