...
public class PuzzlePlayServiceTest {
    ...
    void getAiResponse_ShouldReturnAnswer_WhenHashExists() {
        ...
        Integer aiResponse = puzzlePlayService.getAiResponse(TYPE, SOURCE_ID, currentBoardState);
    ...
    void getAiResponse_ShouldReturnNull_WhenPuzzleNotFound() {
        ...
        Integer aiResponse = puzzlePlayService.getAiResponse(TYPE, 999L, "h8");
    ...
    void getAiResponse_ShouldThrowValidation_WhenBoardStateInvalid() {
        ...
        CustomException exception = assertThrows(
                ...
                () -> puzzlePlayService.getAiResponse(TYPE, SOURCE_ID, "z99")
        );
